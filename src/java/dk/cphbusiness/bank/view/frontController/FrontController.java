...
public class FrontController extends HttpServlet
{
    ...
    public FrontController()
    {
        ...
        commands.put("list-accounts-detail", new ListAccountDetailsCommand("account-detail.jsp"));
        commands.put("prepair-transfer", new PrepairTransferCommand("transfer.jsp"));
        commands.put("transferMoney", new TransferCommand("account-detail.jsp"));
